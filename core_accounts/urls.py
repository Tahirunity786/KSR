...
from core_accounts.views import DeleteUserProfile, GoogleUserRegistrationView, PasswordResetRequestView, PasswordResetView, Register, ShowProfile, UpdateUserProfile, UserLogin
