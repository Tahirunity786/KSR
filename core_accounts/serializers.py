...
class UpdateUserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = [ 'first_name', 'last_name', 'email', 'subject','stage', 'date_of_birth', 'gender', 'mobile_number', 'hourly_rate', 'experience', 'info', 'degree', 'university']
        extra_kwargs = {
...
class ShowUserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            ...
            'experience','university', 'degree', 'info','subject', 'stage', 
        )
        extra_kwargs = {
            'hourly_rate': {'required': False},
